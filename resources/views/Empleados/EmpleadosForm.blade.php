...
@section('content')
    ...
    <div class="max-w-2xl mx-auto mt-10 bg-base-100 p-6 rounded shadow">
        <h2 class="text-2xl text-center font-bold mb-8 text-primary">REGISTRO DE EMPLEADO</h2>
        <form action="{{ route('empleados.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @csrf
